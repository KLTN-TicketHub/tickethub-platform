...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.Event", b =>
                {
                    ...
                    b.Property<string>("CustomAddressLine")
                        .HasMaxLength(200)
                    ...
                    b.Property<string>("CustomDistrict")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("CustomProvinceCity")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("CustomVenueName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("CustomWard")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.ZonePricing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ZonePricing", (string)null);
                });
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.ZonePricing", b =>
                {
                    ...
                    b.HasOne("Catalog.Domain.Entities.TicketType", "TicketType")
                        .WithMany()
