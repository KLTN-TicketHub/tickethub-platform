        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowtimeEndAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderBookingState", x => x.CorrelationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    RowName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
