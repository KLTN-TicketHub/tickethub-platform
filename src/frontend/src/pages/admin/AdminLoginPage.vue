<template>
  <div class="admin-login">
    ...
    <div class="admin-login__card">
      ...
      <form v-if="step === 1" @submit.prevent="handleLogin" class="admin-login__form">
        <!-- Username Field -->
        <div class="admin-login__field">
          <label class="admin-login__label" for="admin-username">Tài khoản</label>
      ...
      <form v-else @submit.prevent="handleConfirm" class="admin-login__form">
        <!-- Verification Code Field -->
        <div class="admin-login__field">
          <label class="admin-login__label" for="admin-code">Mã xác thực (OTP)</label>
          <div class="admin-login__input-wrap">
            <svg class="admin-login__input-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
        ...
        <button
          type="button"
          @click="step = 1"
          class="admin-login__back-link mt-2 self-center border-none bg-transparent cursor-pointer"
        >
