      ...
      <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
          ...
          <tbody class="divide-y divide-white/5">
            ...
            <tr v-else v-for="sm in seatMaps" :key="sm.id" class="hover:bg-white/[0.02] transition-colors group">
              ...
              <td class="px-6 py-4 text-right">
                <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <span class="text-white/30 text-[11px] font-medium mr-2">Chế độ xem</span>
                  <button class="w-8 h-8 rounded-lg bg-white/5 text-white/70 flex items-center justify-center hover:bg-white/10 hover:text-white transition-colors" title="Xem chi tiết (Đang phát triển)" disabled>
                    <PhSquaresFour weight="bold" class="opacity-50" />
                  </button>
                </div>
              </td>
            </tr>
...
import { PhArrowLeft, PhSquaresFour } from '@phosphor-icons/vue'
